...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
        ...
        {
            if (list instanceof Apt1Room)
                ((Apt1Room) list).clean1Room();
            else if (list instanceof Apt2Room)
                ((Apt2Room) list).clean2Rooms();
            else if (list instanceof Apt3Room)
                ((Apt3Room) list).clean3Rooms();
        }
    }
